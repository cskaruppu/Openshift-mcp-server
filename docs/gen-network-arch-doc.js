...
function generateArchDiagram() {
  ...
  ctx.fillText("TCS Agentic AI — Multi-Cluster Network Architecture", W / 2, 40);
  ctx.font = "13px Arial";
  ...
  ctx.font = "12px Arial";
  ctx.textAlign = "center";
  ctx.fillText("TCS Agentic AI Platform  |  Red Hat OpenShift Container Platform  |  Hub-and-Spoke Architecture  |  All communication is agent-initiated", W / 2, H - 16);
...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      para("This document outlines the network architecture and connectivity requirements for extending the TCS Agentic AI platform from a Single Node OpenShift (SNO) deployment to a multi-cluster configuration.", { after: 120 }),
        ...
        new TableCell({
          children: [
            ...
            new Paragraph({ children: [
              ...
              new TextRun({ text: "SNO at 10.131.71.72 — runs TCS Agentic AI MCP Server", size: 20, color: C.gray }),
            ], spacing: { after: 40 } }),
            new Paragraph({ children: [
      ...
      bulletPara("Hub (SNO): Runs the TCS Agentic AI MCP Server. Hosts the unified dashboard, AI chat, and all management tools."),
      ...
      new Table({ width: { size: 100, type: WidthType.PERCENTAGE }, rows: [new TableRow({ children: [
        new TableCell({
          children: [
            ...
            new Paragraph({ children: [new TextRun({ text: "Generated by TCS Agentic AI Platform", size: 18, color: "93C5FD" })], alignment: AlignmentType.CENTER, spacing: { after: 0 } }),
          ],
          shading: { fill: C.navyDark, type: ShadingType.CLEAR },
          borders: noBorders,
...
const outPath = "docs/TCS-Agentic-AI-Multi-Cluster-Network-Architecture.docx";
