      ...
      new Table({ width: { size: 100, type: WidthType.PERCENTAGE }, rows: [new TableRow({ children: [
        new TableCell({
          children: [
            ...
            new Paragraph({ children: [new TextRun({ text: "Generated by TCS KubeNexus AI Platform", size: 16, color: "60A5FA" })], alignment: AlignmentType.CENTER, spacing: { after: 0 } }),
          ],
          shading: { fill: C.navyDark, type: ShadingType.CLEAR },
          borders: noBorders,
...
const outPath = "docs/TCS-KubeNexus-AI-HLD-LLD-Design.docx";
