 ...
 * Generates: TCS-Agentic-AI-UC05-Zero-Touch-Incident-Command.pptx (beside this script)
 *
 * Run: node usecases/uc-05-rca-agent/generate-ppt.cjs
 */
const PptxGenJS = require("pptxgenjs");
const path = require("path");
const fs = require("fs");

const OUT = path.join(__dirname, "TCS-Agentic-AI-UC05-Zero-Touch-Incident-Command.pptx");
