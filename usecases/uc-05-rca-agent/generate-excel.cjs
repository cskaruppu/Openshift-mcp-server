 ...
 * Generates: TCS-Agentic-AI-UC05-Zero-Touch-Incident-Command.xlsx (beside this script)
 *
 * Run: node usecases/uc-05-rca-agent/generate-excel.cjs
 */
const ExcelJS = require("exceljs");
const path = require("path");
const fs = require("fs");

const OUT = path.join(__dirname, "TCS-Agentic-AI-UC05-Zero-Touch-Incident-Command.xlsx");
