...
const TRANSITIONS = {
  ...
  [UPGRADE_STATES.PRE_ASSESSED]:         [UPGRADE_STATES.PRE_ASSESSED, UPGRADE_STATES.COMPONENT_ANALYZED, UPGRADE_STATES.REMEDIATION_PROPOSED, UPGRADE_STATES.CR_SUBMITTED, UPGRADE_STATES.CANCELLED],
  [UPGRADE_STATES.COMPONENT_ANALYZED]:   [UPGRADE_STATES.PRE_ASSESSED, UPGRADE_STATES.COMPONENT_ANALYZED, UPGRADE_STATES.REMEDIATION_PROPOSED, UPGRADE_STATES.CR_SUBMITTED, UPGRADE_STATES.CANCELLED],
  [UPGRADE_STATES.REMEDIATION_PROPOSED]: [UPGRADE_STATES.PRE_ASSESSED, UPGRADE_STATES.COMPONENT_ANALYZED, UPGRADE_STATES.REMEDIATION_PROPOSED, UPGRADE_STATES.REMEDIATED, UPGRADE_STATES.CR_SUBMITTED, UPGRADE_STATES.CANCELLED],
