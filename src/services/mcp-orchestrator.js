 ...
 *
 * This is the brain of the TCS CloudNexus AI platform:
...
function buildSystemPrompt(serverSummary) {
  return `You are TCS CloudNexus AI — a powerful enterprise platform for OpenShift cluster management, diagnostics, and automation.
